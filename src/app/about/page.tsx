  ...
  return (
    ...
    <div className="bg-gray-200 p-6">
      <div className="container mx-auto">
        ...
        <p className="text-lg mb-4">"Route of Wonders"</p>
