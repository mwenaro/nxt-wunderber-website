...
export interface IBookedTour { id: string, created_at: Date, departureDate: Date | string, country: string, name: string, email: string, phone: any, status: any }

const OrderItem = ({ id, created_at, departureDate, country, name, email, phone, status }: IBookedTour
) =>
  <div className="p-2 grid grid-cols-12 gap-1 border-1  border-red-400">
    ...
    <div className="col-span-1 overflow-hidden p-1 flex-2">{`${created_at.valueOf()}`}</div>
